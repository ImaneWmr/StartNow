...
export const generateIdeaFromAI = async (secteur) => {
  console.log(`Le secteur est ${secteur}`);
  try {
        ...
        contents: [
          {
            parts: [
              {
                text: `Donne-moi une idée de startup innovante et originale dans le secteur ${secteur}.`
              }
            ]
          }
        ]
